...
const (
	...
	STORAGE_BINGOCLOUD_CEPH     = "ceph"
	STORAGE_BINGOCLOUD_LOCAL_FS = "localfs"
	STORAGE_BINGOCLOUD_LOCAL_VG = "localvg"

	STORAGE_WINSTACK_LOCAL = "Local"  //本地
	STORAGE_WINSTACK_FCSAN = "FC-SAN" //FC-SAN
	STORAGE_WINSTACK_IPSAN = "IP-SAN" //IP-SAN
	STORAGE_WINSTACK_NAS   = "NAS"    //NAS
	STORAGE_WINSTACK_CEPH  = "CEPH"   //分布式存储
	STORAGE_WINSTACK_NVME  = "NVME"   //本地
)
