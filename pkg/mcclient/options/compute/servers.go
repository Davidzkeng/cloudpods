...
type ServerListOptions struct {
	...
	Hypervisor         string `help:"Show server of hypervisor" choices:"kvm|esxi|container|baremetal|aliyun|azure|aws|huawei|ucloud|zstack|openstack|google|ctyun|winstack"`
...
type ServerConfigs struct {
	...
	Hypervisor                   string `help:"Hypervisor type" choices:"kvm|esxi|baremetal|container|aliyun|azure|qcloud|aws|huawei|openstack|ucloud|zstack|google|ctyun|winstack"`
	ResourceType                 string `help:"Resource type" choices:"shared|prepaid|dedicated"`
